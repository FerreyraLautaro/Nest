...
module.exports = function(app){
							        ...
							        ModelRelationRel.getRelation(datab, (err, data) => {
										...
										if(data){
											...
											data.forEach((producto,i)=>{
												...
												setTimeout( function (i) {getProducts(address,version,producto.origin_id,producto.destination_id,warehouse_list, token, serviceData.id_service, serviceData.database, function(err, resp){
													...
													if(resp){
														...
														if(usaTalle){
															...
															console.log("inicia producto: "+producto.destination_id);

															if(producto.destination_id =='MLA828430307'){
																return;
															}
															...
															getVariantesMeli(producto.destination_id, function(err, respMeli){
																...
																if(respMeli == ''){
																	...
																	console.log("trajo variante vacia");
																...
																else
																{
																	...
																	for(var m = 0; m<respMeli.length; m++){
																		...
																		for( var ac= 0; ac<respMeli[m].attribute_combinations.length; ac++){
																			...
																			//console.log("id_att: "+ id_att_comb);
																		    ...
																		    if(id_att_comb !='COLOR' && busca_wheel == -1)
																		 	{
																		 		tallesRopa = 1;
																			}
																	...
																	if(serviceData.id_service == 27 && tallesRopa != 1){
																		...
																		//if(producto.destination_id == 'MLA788610096'){
																			...
																			for(var f = 0; f<respMeli.length; f++){
																				...
																				if(respMeli[f].picture_ids != undefined){
																					...
																					for(var w = 0; w< respMeli[f].picture_ids.length; w++ ){
																						...
																						pictures2 = pictures2.concat(respMeli[f].picture_ids)
																			...
																			var imagenes = [];
																			for(var x = 0; x< pictures2.length; x++ ){

																			  var position = imagenes.indexOf(pictures2[x])
																			  //console.log(img[w]);
																			  if(position == -1){

																			    imagenes.push(pictures2[x]);
																	...
																	getStockTalles(address, version, producto.origin_id, warehouse_list, token, function(err, stkTalles){
																		...
																		getEqTalle(dataTalles, function(err, equiTalles){
																			...
																			for(var l = 0; l<lotes.length; l++){
																				...
																				if(talle_eq == 1){
																					...
																					for(var c=0; c<equiTalles.length; c++ ){
																						...
																						if(json.talle == nombreTalle){
																							...
																							//console.log("talle original ->"+talle_original+"talle equivalencia ->"+json.equivalencia);
																						}
																				...
																				//tipo de talles. ropa = 1, solo colores = 2
																				var tipoTalles = 1;
																				...
																				if(nombreTalle == 'U'){
																					...
																					tipoTalles = 2;
																					//console.log("nombretalle2 = "+nombreTalle);
																				}
																				if(tallesRopa == 0 && nombreTalle != 'U'){
																					tipoTalles = 5;
																				}
																				//}

																				//busca el json correcto en la funcion jsonAttributes
																				var attribute_combination = jsonAttributes(tipoTalles,color,nombreTalle,referencia,price,cantidadxTalle,talle_original,pictures,wheel_size,serviceData.id_service);
																			...
																			// if(producto.destination_id == 'MLA788610096')
																			// 	console.log(JSON.stringify( {"variations":variations} ));
												...
												console.log("articulo con error");
	...
	function jsonAttributes(tipoTalles,color,nombreTalle,referencia,price,cantidadxTalle,talle_original,pictures,wheel_size,id_service){

		if(wheel_size != '' && tipoTalles == 1){
			tipoTalles = 3;
		}else if (wheel_size != '' && tipoTalles == 2) {
			tipoTalles = 4;
		}
		if(id_service == 27){
			referencia = referencia+' '+nombreTalle;
		}
